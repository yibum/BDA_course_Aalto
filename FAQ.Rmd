...
This the recommended option, as everything is pre-installed and tested.
...
* Choose `CS-E5710 - Bayesian Data Analysis (2025)`
...
* Select the `CS-E5710 - Bayesian Data Analysis (2025) -r-ubuntu:6.2.3-bayesda2025` server.
